...
public class CustomNpcRenderer extends MobRenderer<CustomNpc, CustomNpcModel>{
    private static final ResourceLocation TEXTURE = new ResourceLocation(CustomNpcs.MODID + ":textures/entities/customnpc.png");
    public CustomNpcRenderer(EntityRendererProvider.Context context) {
      super(context, new CustomNpcModel(context.bakeLayer(ModelLayers.VILLAGER)), 0.5F);
    }
